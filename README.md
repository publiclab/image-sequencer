...
This library works in the browser, in Node, and on the commandline (CLI), which we think is great. You can setup a local environement to test the UI with `npm setup` followed by `npm start`
